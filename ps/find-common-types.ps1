<#  find-common-types.ps1
    Detect classes generated in MULTIPLE packages (true "move to common" candidates).
    Writes:
      - common_candidates_detail.csv  (Name, Package, FullPath per occurrence)
      - common_candidates_by_name.csv (Name, PackageCount, Packages, FileCount)
#>
